...
export default function LinkTasksModal({ isOpen, onClose, goal, onTasksLinked }: LinkTasksModalProps) {
    ...
    return (
        <div style={{
            ...
            <div className="glass-panel" style={{ width: '500px', maxHeight: '80vh', padding: '32px', position: 'relative', overflow: 'auto' }}>
                ...
                {loading ? (
                    ...
                    <>
                                ...
                                allTasks.map(task => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            cursor: 'pointer',
                                            background: selectedTaskIds.has(task.id) ? 'rgba(100,200,100,0.1)' : 'transparent',
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', marginTop: '4px' }}>
                                                ...
                                                {(task.goalTasks?.length || 0) > 0 && ` • Linked to ${task.goalTasks?.length} goal${(task.goalTasks?.length || 0) !== 1 ? 's' : ''}`}
                                            </div>
                                        </div>
                                    </div>
                                ))
                        ...
                        <div style={{ marginBottom: '24px', padding: '12px', background: 'rgba(100,200,100,0.1)', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.9rem', color: 'var(--color-text-main)' }}>
                                {selectedTaskIds.size} task{selectedTaskIds.size !== 1 ? 's' : ''} selected for this goal
                            </div>
                        </div>
