                                    ...
                                    <div className="p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h4 className={`font-semibold text-base text-white mb-1 ${gt.task.isCompleted ? 'line-through' : ''}`}>
                                                    {gt.task.title}
                                                </h4>
                                                {gt.task.description && (
                                                    <p className="text-sm text-slate-400 mb-3 leading-relaxed">{gt.task.description}</p>
                                                )}
                                                ...
                                                <div className="flex flex-wrap gap-2 text-xs">
                                                    ...
                                                    {gt.task.isCompleted && gt.task.completedAt && (
                                                        <span className="inline-flex items-center px-2.5 py-1 bg-green-500/20 text-green-300 rounded-full font-medium border border-green-500/40">
                                                            ...
                                                            {new Date(gt.task.completedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                                                        </span>
                                                    )}
                                                </div>
                                            </div>
            ...
            {hasSubgoals && (
                <div>
                    ...
                    <div className="space-y-2.5">
                        {children.map((child) => {
                            const progress = child.targetValue > 0 
                                ...
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {child.description && (
                                                <p className="text-xs text-slate-400 mb-2 leading-relaxed">{child.description}</p>
                                            )}
                                            <div className="flex flex-wrap gap-2 text-xs">
